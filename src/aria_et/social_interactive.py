...
_TRIAL_DEFINITIONS: tuple[_TrialDefinition, ...] = (
    _TrialDefinition("SI-B1", 1, "01", "parallel-play", "sibs1_non_15s.avi"),
    _TrialDefinition("SI-B1", 2, "05", "parallel-play", "sibs5_non_15s.avi"),
    _TrialDefinition("SI-B1", 3, "04", "parallel-play", "sibs4_non_15s.avi"),
    _TrialDefinition("SI-B1", 4, "08", "cooperative-play", "sibs8_soc_15s.avi"),
    _TrialDefinition("SI-B1", 5, "10", "cooperative-play", "sibs10_soc_15s.avi"),
    _TrialDefinition("SI-B1", 6, "03", "parallel-play", "sibs3_non_15s.avi"),
    _TrialDefinition("SI-B2", 7, "02", "cooperative-play", "sibs2_soc_15s.avi"),
    _TrialDefinition("SI-B2", 8, "06", "parallel-play", "sibs6_non_15s.avi"),
    _TrialDefinition("SI-B2", 9, "09", "cooperative-play", "sibs9_soc_15s.avi"),
    _TrialDefinition("SI-B2", 10, "11", "parallel-play", "sibs11_non_15s.avi"),
    _TrialDefinition("SI-B2", 11, "12", "cooperative-play", "sibs12_soc_15s.avi"),
    _TrialDefinition("SI-B3", 12, "01", "cooperative-play", "sibs1_soc_15s.avi"),
    _TrialDefinition("SI-B3", 13, "08", "parallel-play", "sibs8_non_15s.avi"),
    _TrialDefinition("SI-B3", 14, "05", "cooperative-play", "sibs5_soc_15s.avi"),
    _TrialDefinition("SI-B3", 15, "04", "cooperative-play", "sibs4_soc_15s.avi"),
    _TrialDefinition("SI-B3", 16, "03", "cooperative-play", "sibs3_soc_15s.avi"),
    _TrialDefinition("SI-B3", 17, "10", "parallel-play", "sibs10_non_15s.avi"),
    _TrialDefinition("SI-B4", 18, "02", "parallel-play", "sibs2_non_15s.avi"),
    _TrialDefinition("SI-B4", 19, "06", "cooperative-play", "sibs6_soc_15s.avi"),
    _TrialDefinition("SI-B4", 20, "12", "parallel-play", "sibs12_non_15s.avi"),
    _TrialDefinition("SI-B4", 21, "09", "parallel-play", "sibs9_non_15s.avi"),
    _TrialDefinition("SI-B4", 22, "11", "cooperative-play", "sibs11_soc_15s.avi"),
)
